# I2C
Ya hemos visto el mecanismo de comunicación con la UART. La comunicación en serie es ampliamente utilizada porque es simple y ha existido casi desde siempre. (¿Recuerdas por qué se llama al dispositivo host "tty"? Por "TeleTYpe" sí, eso.) Esta ubicuidad y simplicidad lo convierte en una opción muy popular para comunicaciones simples.
