...
Empecemos por aprender a trabajar con los pines necesarios. Hay una guía de programación si sabemos cómo leer diagramas de circuitos electrónicos. 
El esquema eléctrico se encuentra en [esquema de la MB2], podemos buscar el LED que queramos encender y apagar, y determinar qué pines GPIO en el chip nRF52833 están conectados a ese LED. 
...
Vamos a trabajar con el LED en la esquina superior izquierda de la matriz en la MB2. Siguiendo las pistas `ROW1` y `COL1` a las que está conectado este LED, podemos ver que van a los pines del nRF52833 etiquetados como `AC17`/`P0.21` y `B11`/`AIN4`/`P0.28`. 
